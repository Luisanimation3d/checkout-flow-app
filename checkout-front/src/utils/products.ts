...
// Mock temporal: el catálogo real debería venir de un endpoint del backend (GET /products).
...
export const findProductById = (id: string | undefined) => PRODUCTS.find((product) => product.id === id)
